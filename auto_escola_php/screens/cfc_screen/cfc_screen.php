...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="cfc_screen.css">
...
<body>
  ...
  <main>
    <article>
      <section onclick="location.href = `/PWIII/auto_escola_php/screens/cfc_screen/adicionar_screen/adicionar_screen.php`" class="section-adicionar">
